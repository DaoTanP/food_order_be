...
public class MenuItemService {
    ...
    public MenuItems update(Integer id, MenuItems menuItem) {
        MenuItems menuItem1 = menuItemRepository.findById(id)
                .orElseThrow(() -> new ErrorMessage(HttpStatus.NOT_FOUND, "Item not found: "));
    ...
    //
    //
    // public List<MenuItems> findAllByRestaurantIdAndCategory(Integer restaurantId,
    // String category){
    // return menuItemRepository.findAllByRestaurantIdAndCategory(restaurantId,
    // category);
    // }
    //
    // public List<MenuItems> findAllByRestaurantIdAndPrice(Integer restaurantId,
    // Double price){
    // return menuItemRepository.findAllByRestaurantIdAndPrice(restaurantId, price);
    // }
    //
    // public List<MenuItems> findAllByRestaurantIdAndAvailability(Integer
    // restaurantId, Boolean availability){
    // return menuItemRepository.findAllByRestaurantIdAndAvailability(restaurantId,
    // availability);
    // }
    //
    // public List<MenuItems> findAllByCategoryAndPrice(String category, Double
    // price){
    // return menuItemRepository.findAllByCategoryAndPrice(category, price);
    // }
    //
    // public List<MenuItems> findAllByCategoryAndAvailability(String category,
    // Boolean availability){
    // return menuItemRepository.findAllByCategoryAndAvailability(category,
    // availability);
    // }
    //
    // public List<MenuItems> findAllByPriceAndAvailability(Double price, Boolean
    // availability){
